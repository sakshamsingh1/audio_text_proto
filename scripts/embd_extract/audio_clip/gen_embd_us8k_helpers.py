...
data_base_path = '/scratch/sk8974/experiments/audio_text/audio_text_dhh/data/us-8k/US8k/'
label_path = data_base_path+'metadata/UrbanSound8K.csv'
...
class US8k(Dataset):
    def __init__(self):
        audio_base_path = '/scratch/sk8974/experiments/audio_text/audio_text_dhh/data/us-8k/US8k/'
        self.paths = glob.glob(audio_base_path+'audio/fold*/*.wav')
